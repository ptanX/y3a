...
def authenticated_menu():
    ...
    if has_permission("base_information"):
        if st.sidebar.button("Dữ liệu có sẵn", use_container_width=True, key="nav_base_information"):
            st.switch_page("pages/base_information.py")
