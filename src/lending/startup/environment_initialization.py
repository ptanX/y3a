...
def load_data_from_csv_files(
    Session,
    customer_csv_path=CUSTOMER_PROFILE_DATA,
        ...
        with open(customer_csv_path, "r", encoding="utf-8-sig") as file:
            ...
            for row in reader:
                ...
                customer = CustomerProfile(
                    ...
                    ten_cong_ty_tieng_viet=cleaned_row.get(
                        "ten_cong_ty_tieng_viet", ""
                    ),
                    ten_cong_ty_tieng_nuoc_ngoai=cleaned_row.get(
                        "ten_cong_ty_tieng_nuoc_ngoai", ""
                    ),
                    ...
                    nganh_nghe_kinh_doanh_chinh=cleaned_row.get(
                        "nganh_nghe_kinh_doanh_chinh", ""
                    ),
