...
from src.agent.chat_agent_application import (
    ChatAgentApplicationFactory,
...
class AgentApplication:
    ...
    def initialize(
        cls,
        graph: GraphProvider[GRAPH_STATE] | CompiledStateGraph[GRAPH_STATE],
        chat_agent_factory: ChatAgentApplicationFactory[
            GRAPH_STATE, MESSAGE_DTO
        ] = None,
    ) -> ChatAgentApplication:
